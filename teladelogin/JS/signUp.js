//Variavel//Nome da variavel//função interna//argumento da função
...
//nome da variavel//add evento//argumentos da fução
...
senha.addEventListener('keyup', () => {
    ...
    if(confirmSenha.value !== senha.value){
        ...
        labelConfirmSenha.innerHTML = 'Senha *Insira no minimo 5 caracteres';
